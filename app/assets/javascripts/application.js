  ...
  function buildField(index) {  // 追加するフォームのｈｔｍｌを用意
    const html = `<div class="js-file-group" data-index="${index}">
                    ...
                    <div class="tag-area__form">
                      <label for="blog_select_dates_attributes_${index}_event_date">Event date</label>
                      <input type="datetime-local" name="blog[select_dates_attributes][${index}][event_date]" id="blog_select_dates_attributes_${index}_event_date">
